#ifndef GraphicTuner_H
#define GraphicTuner_H
...
/*!
 * \brief The GraphicTuner class
 * \author ALBERT Vincent, NAJIMI Adonis, STERN Valentin
 */

class GraphicTuner : public QWidget
{
    Q_OBJECT
...
public:
    /*!
      ...
      */
     GraphicTuner(QWidget *parent = 0, QString first_note = "A");
